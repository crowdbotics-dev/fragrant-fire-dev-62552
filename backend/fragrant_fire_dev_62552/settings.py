"""
Django settings for fragrant_fire_dev_62552 project.
...
ROOT_URLCONF = 'fragrant_fire_dev_62552.urls'
...
WSGI_APPLICATION = 'fragrant_fire_dev_62552.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fragrant_fire_dev_62552 API",
    "DESCRIPTION": "API documentation for fragrant_fire_dev_62552 App",
    "VERSION": "v1",
}
